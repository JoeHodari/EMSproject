...
<html>
<head>
	<title>Employee Panel | Paperjam Limited</title>
...
<body>
	...
	<div>
		<!-- <h2>Welcome <?php echo "$empName"; ?> </h2> -->
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Empolyee Ranking </h2>
    	<table>
